    ...
    <Layout>
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-6">
            ...
            <div class="card-body text-center">
                <div>
                <b-alert v-if="isFail" show dismissible variant="danger">{{ $t('form.error.invalid-password') }}</b-alert>
                    <table class="table table text-left">
                        <thead>
                            <tr>
                                <td width="30%"><b>{{ $t('user-management.current_password') }}</b></td>
                                <td width="70%">
                            ...
                            <tr>
                                <td width="30%"><b>{{ $t('user-management.new_password') }}</b></td>
                                <td width="70%">
                                    <div class="input-group">
                                        <input
                            ...
                            <tr>
                                <td width="30%"><b>{{ $t('user-management.confirm_password') }}</b></td>
                                <td width="70%">
                                    <div class="input-group">
                                        <input
                ...
                <div class="text-right mr-2">
                    <b-button class="btn" variant="success" @click="updatePassword"> 
...
export default {
    ...
    data() {
        return {
            ...
            title:  this.$t('button.change-password'),
            isFail: false,
            show: {
                curr: false,
                new: false,
            ...
            items: [
                ...
                {
                text: this.$t('button.change-password'),
                active: true
                }
            ]
        };
    ...
    methods:{
        updatePassword(){
            ...
            if (!this.$v.$invalid) {
                ...
                UserService.updateChangePassword(this.id, data)
                .then(response => {
                    Vue.swal({
                        position: "top-end",
                        icon: "success",
