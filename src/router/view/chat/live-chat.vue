          ...
          <div class="py-4 border-bottom">
            <div class="media">
              <div class="align-self-center mr-3">
                <img src="@/assets/images/users/avatar-14.jpg" class="avatar-sm rounded-circle" alt />
              </div>
              <div class="media-body">
                <h5 class="font-size-15 mt-0 mb-1">Yusuf Miftah</h5>
                <p class="text-muted mb-0">
                  <i class="mdi mdi-circle text-success align-middle mr-1"></i> Active
                </p>
              </div>

              <b-dropdown class="chat-noti-dropdown active" right variant="white">
                      ...
                      >
                        <a href="javascript: void(0);">
                          <div class="media">
                            ...
                            <div class="avatar-xs align-self-center mr-3" v-if="!data.image">
                              <span
          ...
          <div class="p-4 border-bottom">
            <div class="row">
              <div class="col-md-4 col-9">
                ...
                <p class="text-muted mb-0">
                  <i class="mdi mdi-circle text-success align-middle mr-1"></i> Active now
                </p>
              </div>
                ...
                <ul class="list-unstyled">
                  <li>
                    <div class="chat-day-title">
                      <span class="title">Today{{chatMessagesData}}</span>
                    </div>
                  </li>
                  <li
                    v-for="data in chatMessagesData"
                    :key="data.message"
