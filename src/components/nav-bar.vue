    ...
    <div class="navbar-header">
         ...
         <div class="row">
           <div class="col-sm-2 text-right my-auto">
              ...
              <router-link tag="a" to="/" class="logo logo-light">
                ...
                <span class="logo-lg">
                    <img src="@/assets/images/logo.png" class="mt-2" width="100%" />
                </span>
              </router-link>
           </div>
           <div class="col-sm-10 my-auto text-left" v-if="sidebar">
              <h4 class="text-white mt-3">SECURE ME</h4>
           </div>
         </div>
        </div>
      ...
      <div class="d-flex">
        ...
        <b-dropdown variant="white" right toggle-class="header-item">
          <template v-slot:button-content>
              <img class src="@/assets/images/flags/en.png" alt="Header Language" height="16" v-if="lang == 'en'"/>
              <img class src="@/assets/images/flags/ina.png" alt="Header Language" height="16" v-else/>
          </template>
          <b-dropdown-item
            class="notify-item"
          ...
          <simplebar style="max-height: 230px;">
            <a href="javascript: void(0);" class="text-reset notification-item">
              <div class="media">
                ...
                <div class="media-body">
                  <h6 class="mt-0 mb-1">New Case</h6>
            ...
            <a href="javascript: void(0);" class="text-reset notification-item">
              <div class="media">
                ...
                />
                <div class="media-body">
                  <h6 class="mt-0 mb-1">New Customer</h6>
                  <div class="font-size-12 text-muted">
        ...
        <b-dropdown right variant="black" toggle-class="header-item">
          <template v-slot:button-content>
            <img
              ...
              alt="Avatar"
            />
            <span class="d-none d-xl-inline-block ml-1"> {{users.email}} </span>
            <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
          </template>
          <!-- item-->
          <router-link to="/profile-user" class="text-secondary">
            <div class="dropdown-item d-block btn-block">
              <i class="bx bx-user font-size-16 align-middle mr-1"></i>
                {{ $t('button.profile') }}
            </div>
          </router-link>

          <router-link to="/change-password" class="text-secondary">
            <div class="dropdown-item d-block btn-block">
...
export default {
  data() {
    return {
      sidebar: true,
      lang: '',
      users: store.state.authBackend.user,
      urlImage: '@/assets/images/users/avatar-10.jpg',
      avatar: '',
      ...
      languages: [
        ...
        {
          flag: require("@/assets/images/flags/ina.png"),
          language: "id",
          title: "Indonesian"
        }
      ]
  ...
  mounted(){
    window.addEventListener('ava-changed', (event) => {
